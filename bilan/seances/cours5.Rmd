...
On considère que : $Z_i \sim \text{Multinomial}(\pi_1, \ldots, \pi_K)$
...
Autrement dit : $p(x \mid z_k = 1) = \mathcal{N}(x \mid \mu_k, \Sigma_k)$
...
Cette étape correspond à l’**étiquetage probabiliste** (soft asignment) :
...
-   pour un individu i $\sum^{K}_{k=1} \gamma{(z_{ik})} = 1$
